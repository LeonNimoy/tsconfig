...
const reactTsconfig = JSON.stringify(require('./config/tsconfig.react.json'), null, 2)
const nodeTsconfig = JSON.stringify(require('./config/tsconfig.node.json'), null, 2)
